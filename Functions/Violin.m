    ...
    methods
        ...
        function set.EdgeColor(obj, color)
            if ~isempty(obj.ViolinPlot)
                obj.ViolinPlot.EdgeColor = [0 0 0];
...
%                 obj.ViolinPlot
        ...
        function set.BoxColor(obj, color)
            if ~isempty(obj.BoxPlot)
                obj.BoxPlot.FaceColor = [1 1 1];
                obj.BoxPlot.EdgeColor = [0 0 0];
                obj.BoxPlot.LineWidth = 1;
                obj.WhiskerPlot.Color = [0 0 0];
                obj.WhiskerPlot.LineWidth = 1;
                obj.MedianPlot.Marker = '+';
                obj.MedianPlot.SizeData = 150;
                obj.MedianPlot.MarkerEdgeColor = [0 0 0];
                obj.MedianPlot.MarkerFaceColor = [0 0 0];
                obj.MedianPlot.LineWidth = 1;
                obj.NotchPlots(1).MarkerFaceColor = color;
                obj.NotchPlots(2).MarkerFaceColor = color;
            end
        end
