function violins = violinplot_sijia(data, cats, varargin)
...
% This code is released under the terms of the BSD 3-clause license
    ...
    elseif hascategories && numel(data) == numel(cats)
        ...
        for n = 1:length(catnames)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%%% Sijia's modification: take colour for each group  %%%          
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            varargin1 = varargin;
            colour = varargin{2};
            varargin1{2} = colour(n,:);
            
            violins(n) = Violin(thisData, n, varargin1{:});
        end
